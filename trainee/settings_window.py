...
def launch():
    ...
    def close():
        ...
        Button(win, text='CLOSE', bg='#FFF3C7', command=close).place(x=560, y=120)

    #restart
    Button(win, text='Restart Progress', width=30, height=3, font='none 12', bg='#FFF3C7', command='').place(x=140, y=200)

    #rest time
    Button(win, text='Share Progress', width=30, height=3, font='none 12', bg='#FFF3C7', command='').place(x=140, y=350)
